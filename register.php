...
<head>
  ...
  <title>Near East Hospital</title>
      ...
      <div class="row align-items-center intro-title">
        <div class="col-12">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"> <i class="fas fa-chevron-right"></i> <a href="javascript:void(0)">Register</a>
            </li>
          </ol>
        </div>
      </div>
        ...
        <div class="col-xl-7 col-lg-9 col-md-10">
          <div class="login-form">
            <form action="register.php" method="post">
              <h3 class="mb-4 text-center color-link">Register to your Account</h3>
              <div class="row align-items-center">
                ...
                <div class="col-sm-12 mb-0">
                  <button type="submit" id="register" name="create" class="btn btn-blue-1 my-3 my-sm-0">Sign up</button>
                  <span class="ms-3">Already Registered User? <a href="login.php">Click here to login</a></span>
                </div>
              </div>
            </form>
